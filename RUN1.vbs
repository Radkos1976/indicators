...
For Each objitem In colProcesses
    if instr(1,objitem.CommandLine,"5S.vbs")>0 then chk="true"
    if instr(1,objitem.CommandLine,"WYD.vbs")>0 then chk1="true"	
Next
end if
...
intReturn = objProcess.Create _
    ("C:\Windows\SysWOW64\cscript.exe //NoLogo D:\boardinfo\5S.vbs", Null, objConfig, intProcessID)
end if
if chk1<>"true" then
Set objProcess1 = objWMIService.Get("Win32_Process")
intReturn = objProcess1.Create _
    ("C:\Windows\SysWOW64\cscript.exe //NoLogo D:\boardinfo\WYD.vbs", Null, objConfig, intProcessID)
end if
